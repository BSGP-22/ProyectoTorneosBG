...
namespace Administracion_Torneos.BD
{
    public class arbitroDB
    {
            ...
            using (SqlConnection conexion = new SqlConnection(connectionstring))
            {
                ...
                try
                {
                    ...
                    while (reader.Read())
                    {
                        ...
                        arbitroo.Arbitraje = reader.GetDecimal(9);
        ...
        public void Insertar_arbitro(Arbitro arbitro)
        {
            ...
            string query = "exec insertar_arbitros @DPI, @nombre,@apellido,@direccion,@telefono,@nacionalidad,@fechaNac,@correo,@rol, @arbitraje ";
            using (SqlConnection conexion = new SqlConnection(connectionstring))
            {
                SqlCommand sql = new SqlCommand(query, conexion);
                ...
                sql.Parameters.AddWithValue("@arbitraje", arbitro.Arbitraje);
        ...
        public void actualizar_arbitro(int? DPI, string Nombre, string Apellidos, string Direccion,string telefono,string Nacionalidad,DateTime FechaNac,string Correo,string Rol, decimal arbitraje)
        {
            

            string query = "exec actualizar_arbitros @DPI, @nombre,@apellido,@direccion,@telefono,@nacionalidad,@fechaNac,@correo,@rol, @arbitraje";
            using (SqlConnection conexion = new SqlConnection(connectionstring))
            {
                ...
                command.Parameters.AddWithValue("@arbitraje", arbitraje);
